            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="POST" action=" {{ route('storeBulanan', $kegiatan->id) }}">
                                @csrf
                                <input type="hidden" name="tahunan_id" value="{{ $kegiatan->id }}">
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="choices form-select" name="proker_id" id="proker_id" type="text" aria-placeholder="Program Kerja" required>
                                                ...
                                                <option value="{{ $prokers->id }}" {{ (old('proker_id') ?? $kegiatan->tor->proker_id) == $prokers->id ? 'selected' : '' }}>
                                                    {{ $prokers->nama }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Nama Kegiatan" name="nama_kegiatan" value="{{ old('nama_kegiatan') ?? $kegiatan->tor->nama_kegiatan }}">
                                            @error('nama_kegiatan')
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="month" name="waktu" class="form-control" value="{{ old('waktu') ?? $kegiatan->tor->waktu }}">
                                    </div>
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div id="outcome-wrapper">
                                                            @foreach($kegiatan->tor->outcomeKegiatan as $index => $outcome)
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        ...
                                                        <div id="indikator-wrapper">
                                                            @foreach($kegiatan->tor->indikatorKegiatan as $index => $indikator)
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Person In Charge" name="pic" value="{{ old('pic') ?? $kegiatan->tor->pic }}">
                                            @error('pic')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Kepesertaan Kegiatan" name="kepesertaan" value="{{ old('kepesertaan') ?? $kegiatan->tor->kepesertaan }}">
                                            @error('kepesertaan')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Nomor Standar Akreditasi" name="nomor_standar_akreditasi" value="{{ old('nomor_standar_akreditasi') ?? $kegiatan->tor->nomor_standar_akreditasi }}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Penjelasan Standar Akreditasi" name="penjelasan_standar_akreditasi" value="{{ old('penjelasan_standar_akreditasi') ?? $kegiatan->tor->penjelasan_standar_akreditasi }}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="choices form-select" name="coa_id" id="coa_id" type="text" aria-placeholder="COA">
                                                @foreach ($coa as $coas)
                                                <option value="{{ $coas->id }}" {{ (old('coa_id') ?? $kegiatan->tor->coa_id) == $coas->id ? 'selected' : '' }}>
                                                    {{ $coas->kode }} - {{ $coas->nama }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Latar Belakang Kegiatan" name="latar_belakang" value="{{ old('latar_belakang') ?? $kegiatan->tor->latar_belakang }}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Tujuan" name="tujuan" value="{{ old('tujuan') ?? $kegiatan->tor->tujuan }}">
                                            @error('tujuan')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Manfaat Internal" name="manfaat_internal" value="{{ old('manfaat_internal') ?? $kegiatan->tor->manfaat_internal }}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Manfaat Eksternal" name="manfaat_eksternal" value="{{ old('manfaat_eksternal') ?? $kegiatan->tor->manfaat_eksternal }}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                placeholder="Metode Pelaksanaan" name="metode_pelaksanaan" value="{{ old('metode_pelaksanaan') ?? $kegiatan->tor->metode_pelaksanaan }}">
