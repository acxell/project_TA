...
<div class="page-heading">
    ...
    <section id="detail-kegiatan">
        <div class="row match-height">
            <div class="col-12">
                <div class="card">
                    <form class="form" action="{{ route('pendanaan.dataPendanaan.create', $kegiatan->id) }}">
                        @csrf
                        ...
                        <div class="modal-body">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Nama Program Kerja</th>
                                        <td>{{ $kegiatan->tor->proker->nama }}</td>
                                    </tr>
                                    <tr>
                                        <th>Pengguna</th>
                                    ...
                                    <tr>
                                        <th>Total Biaya</th>
                                        <td>Rp {{ number_format($kegiatan->tor->rab->total_biaya, 0, ',', '.') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
